...
class PhotoResourceIT {
    ...
    private static final String DEFAULT_LINK_TO_PHOTO_FILE = "AAAAAAAAAA";
    private static final String UPDATED_LINK_TO_PHOTO_FILE = "BBBBBBBBBB";
    ...
    public static Photo createEntity(EntityManager em) {
        Photo photo = new Photo()
            .title(DEFAULT_TITLE)
            .linkToPhotoFile(DEFAULT_LINK_TO_PHOTO_FILE)
    ...
    public static Photo createUpdatedEntity(EntityManager em) {
        Photo photo = new Photo()
            .title(UPDATED_TITLE)
            .linkToPhotoFile(UPDATED_LINK_TO_PHOTO_FILE)
    ...
    void createPhoto() throws Exception {
        ...
        assertThat(testPhoto.getLinkToPhotoFile()).isEqualTo(DEFAULT_LINK_TO_PHOTO_FILE);
        assertThat(testPhoto.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testPhoto.getAuthor()).isEqualTo(DEFAULT_AUTHOR);
        assertThat(testPhoto.getOwner()).isEqualTo(DEFAULT_OWNER);
    ...
    @Test
    @Transactional
    void checkLinkToPhotoFileIsRequired() throws Exception {
        int databaseSizeBeforeTest = photoRepository.findAll().size();
        // set the field null
        photo.setLinkToPhotoFile(null);
    ...
    void getAllPhotos() throws Exception {
        ...
        restPhotoMockMvc
            ...
            .andExpect(jsonPath("$.[*].linkToPhotoFile").value(hasItem(DEFAULT_LINK_TO_PHOTO_FILE)))
    ...
    void getPhoto() throws Exception {
        ...
        restPhotoMockMvc
            ...
            .andExpect(jsonPath("$.linkToPhotoFile").value(DEFAULT_LINK_TO_PHOTO_FILE))
    ...
    void putExistingPhoto() throws Exception {
        ...
        assertThat(testPhoto.getLinkToPhotoFile()).isEqualTo(UPDATED_LINK_TO_PHOTO_FILE);
        assertThat(testPhoto.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testPhoto.getAuthor()).isEqualTo(UPDATED_AUTHOR);
        assertThat(testPhoto.getOwner()).isEqualTo(UPDATED_OWNER);
