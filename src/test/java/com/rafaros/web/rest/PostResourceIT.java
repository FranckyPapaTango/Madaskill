...
import com.rafaros.domain.Post;
import com.rafaros.repository.PostRepository;
...
class PostResourceIT {
    ...
    private static final String DEFAULT_RESUMEE = "AAAAAAAAAA";
    private static final String UPDATED_RESUMEE = "BBBBBBBBBB";

    private static final String DEFAULT_AUTEUR = "AAAAAAAAAA";
    private static final String UPDATED_AUTEUR = "BBBBBBBBBB";

    private static final Instant DEFAULT_DATE_PERSISTENCE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_PERSISTENCE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post()
            ...
            .resumee(DEFAULT_RESUMEE)
            .auteur(DEFAULT_AUTEUR)
            .datePersistence(DEFAULT_DATE_PERSISTENCE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post()
            ...
            .resumee(UPDATED_RESUMEE)
            .auteur(UPDATED_AUTEUR)
            .datePersistence(UPDATED_DATE_PERSISTENCE);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getCategorie()).isEqualTo(DEFAULT_CATEGORIE);
        assertThat(testPost.getResumee()).isEqualTo(DEFAULT_RESUMEE);
        assertThat(testPost.getAuteur()).isEqualTo(DEFAULT_AUTEUR);
        assertThat(testPost.getDatePersistence()).isEqualTo(DEFAULT_DATE_PERSISTENCE);
    }
    ...
    @Test
    @Transactional
    void checkDatePersistenceIsRequired() throws Exception {
        int databaseSizeBeforeTest = postRepository.findAll().size();
        // set the field null
        post.setDatePersistence(null);
    ...
    void getAllPosts() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.[*].resumee").value(hasItem(DEFAULT_RESUMEE)))
            .andExpect(jsonPath("$.[*].auteur").value(hasItem(DEFAULT_AUTEUR)))
            .andExpect(jsonPath("$.[*].datePersistence").value(hasItem(DEFAULT_DATE_PERSISTENCE.toString())));
    }
    ...
    void getPost() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.resumee").value(DEFAULT_RESUMEE))
            .andExpect(jsonPath("$.auteur").value(DEFAULT_AUTEUR))
            .andExpect(jsonPath("$.datePersistence").value(DEFAULT_DATE_PERSISTENCE.toString()));
    }
    ...
    void putExistingPost() throws Exception {
        ...
        assertThat(testPost.getCategorie()).isEqualTo(UPDATED_CATEGORIE);
        assertThat(testPost.getResumee()).isEqualTo(UPDATED_RESUMEE);
        assertThat(testPost.getAuteur()).isEqualTo(UPDATED_AUTEUR);
        assertThat(testPost.getDatePersistence()).isEqualTo(UPDATED_DATE_PERSISTENCE);
    }
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.resumee(UPDATED_RESUMEE).datePersistence(UPDATED_DATE_PERSISTENCE);
