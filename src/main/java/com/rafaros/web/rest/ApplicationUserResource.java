...
/**
 * REST controller for managing {@link com.rafaros.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
public class ApplicationUserResource {
    ...
    public ResponseEntity<List<ApplicationUser>> getAllApplicationUsers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
