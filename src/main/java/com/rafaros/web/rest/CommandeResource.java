...
import com.rafaros.repository.CommandeRepository;
import com.rafaros.service.CommandeService;
...
/**
 * REST controller for managing {@link com.rafaros.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
public class CommandeResource {
    ...
    public ResponseEntity<List<Commande>> getAllCommandes(
        ...
        if ("customer-is-null".equals(filter)) {
            log.debug("REST request to get all Commandes where customer is null");
            return new ResponseEntity<>(commandeService.findAllWhereCustomerIsNull(), HttpStatus.OK);
        }
