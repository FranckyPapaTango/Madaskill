...
@RestController
@RequestMapping("/api/madaskill-kafka")
public class MadaskillKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MadaskillKafkaResource.class);
    ...
    public MadaskillKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
