...
import com.rafaros.service.ProductService;
...
/**
 * REST controller for managing {@link com.rafaros.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public ResponseEntity<List<Product>> getAllProducts(
        ...
        if ("lineitem-is-null".equals(filter)) {
            log.debug("REST request to get all Products where lineItem is null");
            return new ResponseEntity<>(productService.findAllWhereLineItemIsNull(), HttpStatus.OK);
        }
