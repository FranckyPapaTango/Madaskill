...
export const CommandeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="madaskillApp.commande.delete.question">
        <Translate contentKey="madaskillApp.commande.delete.question" interpolate={{ id: commandeEntity.id }}>
