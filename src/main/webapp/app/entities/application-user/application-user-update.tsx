  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="madaskillApp.applicationUser.home.createOrEditLabel" data-cy="ApplicationUserCreateUpdateHeading">
            <Translate contentKey="madaskillApp.applicationUser.home.createOrEditLabel">Create or edit a ApplicationUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('madaskillApp.applicationUser.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('madaskillApp.applicationUser.email')}
              ...
              />
              <ValidatedField
                label={translate('madaskillApp.applicationUser.libelleAdresse')}
                id="application-user-libelleAdresse"
                name="libelleAdresse"
                data-cy="libelleAdresse"
                type="text"
              />
              <ValidatedField
                label={translate('madaskillApp.applicationUser.villeTown')}
                id="application-user-villeTown"
                name="villeTown"
                data-cy="villeTown"
                type="text"
              />
              <ValidatedField
                label={translate('madaskillApp.applicationUser.paysCountry')}
                id="application-user-paysCountry"
                name="paysCountry"
                data-cy="paysCountry"
                type="text"
                validate={{
              ...
              <ValidatedField
                ...
                label={translate('madaskillApp.applicationUser.internalUser')}
                type="select"
              >
                <option value="" key="0" />
                {users
