...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="madaskillApp.applicationUser.delete.question">
        <Translate contentKey="madaskillApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
