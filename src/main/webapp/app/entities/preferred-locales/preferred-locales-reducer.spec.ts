...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './preferred-locales.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDLOCALES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDLOCALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDLOCALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDLOCALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDLOCALES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDLOCALES actions', async () => {
      const expectedActions = [
        {
