...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICESETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVOICESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVOICESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVOICESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVOICESETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVOICESETTINGS actions', async () => {
      const expectedActions = [
        {
