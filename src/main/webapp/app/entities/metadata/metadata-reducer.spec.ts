...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './metadata.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_METADATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_METADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_METADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_METADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_METADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_METADATA actions', async () => {
      const expectedActions = [
        {
